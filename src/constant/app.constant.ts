...
export const NEXT_PUBLIC_BASE_DOMAIN = process.env.NEXT_PUBLIC_BASE_DOMAIN || "http://localhost:1424/";
...
export const FOLDER_IMAGE_BE = `attachments/images/avatar/`;

export const TITLE = `Apartment bussiness`;
